var x = function(t) {
    ...
    if (!window.csGlobal) {
        ...
        k.csHooks.filter("hash_scrolling_offset", function(t) {
            ...
            var i = (0, n.default)(".x-navbar-fixed-top-active .x-nav-wrap.desktop");
            if (e) {
                t -= e - (0, k.adminBarOffset)()
            } else if (i.length > 0 && "none" !== i.css("display")) {
                t -= i.closest(".x-navbar").outerHeight()
            }
            return t
        });
    ...
    n.default.extend(n.default.easing, {
        xEaseOutQuad: function t(e) {
            return 1 - (1 - e) * (1 - e)
        },
        xEaseOutQuart: function t(e) {
            return 1 - Math.pow(1 - e, 4)
        },
        xEaseOutExpo: function t(e) {
            return e === 1 ? 1 : 1 - Math.pow(2, -10 * e)
        },
        xEaseInOutExpo: function t(e) {
    ...
    (function(t, e, i) {
        ...
        w.special.xsmartresize = {
            setup: function t() {
                e(this).on("resize", w.special.xsmartresize.handler)
            },
            teardown: function t() {
                e(this).off("resize", w.special.xsmartresize.handler)
            },
        ...
        e.xIsotope.prototype = {
            _create: function t(i) {
                ...
                if (this.options.resizable) {
                    C.on("xsmartresize.isotope", function() {
                        c.resize()
                    })
                }
        ...
        e.fn.xIsotope = function(t, i) {
            if (typeof t === "string") {
                ...
                this.each(function() {
                    ...
                    if (!i) {
                        S("cannot call methods on isotope prior to initialization; " + "attempted to call method '" + t + "'");
                        return
                    }
                    if (!e.isFunction(i[t]) || t.charAt(0) === "_") {
                        S("no such method '" + t + "' for isotope instance");
                        return
                    }
                    i[t].apply(i, s)
                })
    ...
    e.default = function(t) {
        var e = t.$body;
        (0, n.default)(".x-btn-navbar, .x-btn-navbar-search, .x-btn-widgetbar").on("click", function(t) {
            t.preventDefault()
        });
        ...
        (0, n.default)(function(t) {
            ...
            t(".x-slider-container.above .x-slider-scroll-bottom").on("touchstart click", function(i) {
                ...
                var n = t(".x-navbar-fixed-top-active .x-nav-wrap.desktop");
                if (n.length > 0 && "none" !== n.css("display")) {
                    s += n.closest(".x-navbar").outerHeight()
                }
                e(s)
            });
            t(".x-slider-container.below .x-slider-scroll-bottom").on("touchstart click", function(i) {
                i.preventDefault();
                e(t(".x-masthead, .masthead").first().outerHeight() + t(".x-slider-container.above").outerHeight() + t(".x-slider-container.below").outerHeight())
            })
        })
    };
    var s = i(0);
    ...
    e.default = function(t) {
        ...
        m.find("li.menu-item-has-children > a").each(function(t) {
            (0, n.default)(this).append('<div class="x-sub-toggle collapsed" data-x-toggle="collapse-b" data-x-toggleable="x-nav-wrap-mobile-sm-' + t + '" aria-expanded="false" aria-haspopup="true" aria-controls="x-nav-wrap-mobile-sm-' + t + '">' + '<span><i class="x-icon-angle-double-down" data-x-icon-s="&#xf103;"></i></span>' + "</div>")
        });
    ...
    function p(t) {
        ...
        function a() {
            ...
            d.forEach(function(t) {
                ...
                var i = t.$space.height();
                t.height = i || t.$el.height();
