...
window.Typekit.config = {
    "a": "4635236",
    "c": [".tk-tandelle", "\"tandelle\",sans-serif"],
    "fi": [1142],
    "fc": [{
        "id": 1142,
        "family": "tandelle",
        "src": "https://use.typekit.net/af/0917e5/00000000000000003b9afe8a/27/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "display": "auto",
...
/*{"k":"1.19.2","auto_updating":true,"last_published":"2018-07-28 09:02:15 UTC"}*/
;
