(window.webpackJsonp = window.webpackJsonp || []).push([
    [2], {
        "+8Os": function(e, t, r) {
            ...
            r.d(t, "a", function() {
                ...
                updateProjectionMatrix: function() {
                    var e = this.near,
                        t = e * n(.5 * c.a.DEG2RAD * this.fov) / this.zoom,
                        r = 2 * t,
                        a = this.aspect * r,
                        i = -.5 * a,
                        o = this.view;
                ...
                expandByObject: function() {
                    function e(e) {
                        ...
                        if (void 0 !== n)
                            ...
                            if (void 0 !== s)
                                for (a = 0, i = s.count; a < i; a++) t.fromBufferAttribute(s, a).applyMatrix4(e.matrixWorld), r.expandByPoint(t)
                        }
                    }
                    var t = new s.a,
                        r, a, i;
            ...
            Object.assign(a.prototype, {
                ...
                getInverse: function(e, t) {
                    var r = this.elements,
                        ...
                        x = a[14],
                        y = a[15],
                        _ = m * x * p - v * g * p + v * c * f - d * x * f - m * c * y + d * g * y,
                ...
                distanceSqToSegment: function() {
                    ...
                    return function(a, i, s, l) {
                        ...
                        var d = .5 * a.distanceTo(i),
                            ...
                            c = Math.abs(1 - p * p),
                            f, h, v, x;
                        if (!(0 < c)) h = 0 < p ? -d : d, f = n(0, -(p * h + u)), v = -f * f + h * (h + 2 * m) + g;
                        else if (f = p * m - u, h = p * u - m, x = d * c, !(0 <= f)) h <= -x ? (f = n(0, -(-p * d + u)), h = 0 < f ? -d : o(n(-d, -m), d), v = -f * f + h * (h + 2 * m) + g) : h <= x ? (f = 0, h = o(n(-d, -m), d), v = h * (h + 2 * m) + g) : (f = n(0, -(p * d + u)), h = 0 < f ? d : o(n(-d, -m), d), v = -f * f + h * (h + 2 * m) + g);
                        else if (!(h >= -x)) h = -d, f = n(0, -(p * h + u)), v = -f * f + h * (h + 2 * m) + g;
                        else if (h <= x) {
                            var y = 1 / c;
        ...
        D10d: function(e, t, r) {
            ...
            function o(e, t, r, a) {
                if (!1 !== e.visible && (e.raycast(t, r), !0 === a))
                    for (var n = e.children, s = 0, i = n.length; s < i; s++) o(n[s], t, r, !0)
            }
            r.d(t, "a", function() {
                return a
            });
        ...
        EpSA: function(e, t, r) {
            ...
            function A(e, t, r) {
                for (var a = Array.from ? Array.from(e) : (e + "").split(""), n = t / r.resolution, o = (r.boundingBox.yMax - r.boundingBox.yMin + r.underlineThickness) * n, s = [], l = 0, d = 0, c = 0, i; c < a.length; c++)
                    if (i = a[c], "\n" === i) l = 0, d -= o;
                    else {
                        var p = D(i, n, l, d, r);
            ...
            Object.assign(a.prototype, {
                ...
                computeFrenetFrames: function(e, t) {
                    ...
                    if (!0 === t)
                        for (c = G(q.a.clamp(n[0].dot(n[e]), -1, 1)), c /= e, 0 < a[0].dot(s.crossVectors(n[0], n[e])) && (c = -c), d = 1; d <= e; d++) n[d].applyMatrix4(l.makeRotationAxis(a[d], c * d)), o[d].crossVectors(a[d], n[d]);
                    return {
                        tangents: a,
                        normals: n,
                        binormals: o
            ...
            l.prototype = Object.create(a.prototype), l.prototype.constructor = l, l.prototype.isCatmullRomCurve3 = !0, l.prototype.getPoint = function(e, t) {
                ...
                getPoints: function(e) {
                    ...
                    for (var t = [], r = 0, a = this.curves, i; r < a.length; r++)
                        for (var n = a[r], o = n && n.isEllipseCurve ? 2 * e : n && (n.isLineCurve || n.isLineCurve3) ? 1 : n && n.isSplineCurve ? e * n.points.length : e, s = n.getPoints(o), l = 0, d; l < s.length; l++) d = s[l], i && i.equals(d) || (t.push(d), i = d);
            ...
            Object.assign(P.prototype, {
                ...
                toShapes: function(e, t) {
                    ...
                    for (var x = 0, i = o.length; x < i; x++) c = o[x], v = c.getPoints(), d = n(v), d = e ? !d : d, d ? (!u && g[h] && h++, g[h] = {
                        s: new w,
                        p: v
                    }, g[h].s.curves = c.curves, u && h++, f[h] = []) : f[h].push({
                        h: c,
                        p: v[0]
                    });
                    if (!g[0]) return r(o);
            ...
            Object.assign(R.prototype, {
                load: function(e, t, r, a) {
                    ...
                    if (void 0 !== te[e]) return void te[e].push({
                        onLoad: t,
                        onProgress: r,
                        onError: a
                    });
        ...
        IJRe: function(e, t, r) {
            ...
            function a(e, t, r, a, n) {
                ...
                if (n === 0 < A(e, t, r, a))
                    ...
                    for (o = r - a; o >= t; o -= a) i = b(o, e[o], e[o + 1], i);
            ...
            function n(e, t) {
                ...
                var r = e,
                    a;
                do
                    if (a = !1, !r.steiner && (M(r, r.next) || 0 === _(r.prev, r, r.next))) {
        ...
        IT9u: function(e, t, r) {
            ...
            function p() {
                ...
                this.uniform = c, this.numPlanes = 0, this.numIntersection = 0, this.init = function(e, r, i) {
                    ...
                    if (!o || null === r || 0 === r.length || s && !d) s ? t(null) : e();
                    else {
                        var g = s ? 0 : n,
                            f = 4 * g,
            ...
            function m(e, t, r) {
                ...
                return {
                    ...
                    update: function(e) {
                        ...
                        for (var n in o)
                            for (var s = o[n], d = 0, i = s.length; d < i; d++) t.update(s[d], 34962)
                    },
                    getWireframeAttribute: function(e) {
                        ...
                        if (null !== s)
                            for (var p = s.array, u = 0, i = p.length; u < i; u += 3) {
                                ...
                                for (var p = d.position.array, u = 0, i = p.length / 3 - 1; u < i; u += 3) {
                                    var l = u + 0,
                                        a = u + 1,
                                        m = u + 2;
                                    o.push(l, a, a, m, m, l)
            ...
            function ye(e, t, r) {
                ...
                this.getParameters = function(t, n, s, l, d, c, p) {
                    ...
                    var a = [];
                    if (r.shaderID ? a.push(r.shaderID) : (a.push(t.fragmentShader), a.push(t.vertexShader)), void 0 !== t.defines)
                ...
                return {
                    setup: function(n, o, s) {
                        for (var d = 0, c = 0, p = 0, u = 0, m = 0, g = 0, f = 0, h = 0, v = s.matrixWorldInverse, x = 0, y = n.length; x < y; x++) {
                            ...
                            if (l.isAmbientLight) d += _.r * b, c += _.g * b, p += _.b * b;
            ...
            function Ne(e, t, r, a) {
                ...
                function l() {
                    if (null === w && (w = [], t.get("WEBGL_compressed_texture_pvrtc") || t.get("WEBGL_compressed_texture_s3tc") || t.get("WEBGL_compressed_texture_etc1") || t.get("WEBGL_compressed_texture_astc")))
                        for (var r = e.getParameter(34467), a = 0; a < r.length; a++) w.push(r[a]);
                    return w
                }
                ...
                var y = new function() {
                    ...
                    W = !1,
                    q = 0,
                    X = e.getParameter(7938); - 1 === X.indexOf("WebGL") ? -1 !== X.indexOf("OpenGL ES") && (q = parseFloat(/^OpenGL\ ES\ ([0-9])/.exec(X)[1]), W = 2 <= q) : (q = parseFloat(/^WebGL\ ([0-9])/.exec(X)[1]), W = 1 <= q);
                var j = null,
                    Y = {},
                    J = new ot.a,
                    Z = new ot.a,
            ...
            function Ie(e, t, r, a, n, o, s) {
                ...
                function h(t) {
                    var r = a.get(t);
                    if (t.image && r.__image__webglTextureCube) e.deleteTexture(r.__image__webglTextureCube);
                    else {
                ...
                function v(t) {
                    var r = a.get(t),
                        n = a.get(t.texture);
                    if (t) {
                        if (void 0 !== n.__webglTexture && e.deleteTexture(n.__webglTexture), t.depthTexture && t.depthTexture.dispose(), t.isWebGLRenderTargetCube)
                            for (var o = 0; 6 > o; o++) e.deleteFramebuffer(r.__webglFramebuffer[o]), r.__webglDepthbuffer && e.deleteRenderbuffer(r.__webglDepthbuffer[o]);
                ...
                function _(t, a, f) {
                    ...
                    } else if (a.isDataTexture3D) r.texImage3D(32879, 0, S, x.width, x.height, x.depth, 0, b, M, x.data), t.__maxMipLevel = 0;
                ...
                function S(t, r) {
                    ...
                    if (r.depthTexture.format === je.t) e.framebufferTexture2D(36160, 36096, 3553, n, 0);
                    else if (r.depthTexture.format === je.u) e.framebufferTexture2D(36160, 33306, 3553, n, 0);
            ...
            function Ge(e) {
                ...
                function a(e) {
                    for (var t = navigator.getGamepads && navigator.getGamepads(), r = 0, a = 0, i = t.length, n; r < i; r++)
                        if (n = t[r], n && ("Daydream Controller" === n.id || "Gear VR Controller" === n.id || "Oculus Go Controller" === n.id || "OpenVR Gamepad" === n.id || n.id.startsWith("Oculus Touch") || n.id.startsWith("Spatial Controller"))) {
                            if (a === e) return n;
                            a++
                        }
                }
                ...
                function n() {
                    for (var e = 0; e < c.length; e++) {
                        ...
                        if (void 0 !== r && void 0 !== r.pose) {
                            ...
                            b[e] !== r.buttons[n].pressed && (b[e] = r.buttons[n].pressed, !0 === b[e] ? t.dispatchEvent({
                                type: "selectstart"
                            }) : (t.dispatchEvent({
                                type: "selectend"
                            }), t.dispatchEvent({
            ...
            function Oe(e) {
                ...
                x.layers.enable(1), x.layers.enable(2), this.enabled = !1, this.getController = function(e) {
                    ...
                    d = t, null !== d && (d.addEventListener("select", r), d.addEventListener("selectstart", r), d.addEventListener("selectend", r), d.addEventListener("end", a), d.baseLayer = new XRWebGLLayer(d, s, {
            ...
            function Be(e) {
                ...
                function L(e, t, r, a) {
                    if (!1 !== e.visible) {
                        ...
                        if (n)
                            ...
                            else if (e.isLight) re.pushLight(e), e.castShadow && re.pushShadow(e);
                        else if (e.isSprite) {
                        ...
                        } else if (e.isImmediateRenderObject) a && Ue.setFromMatrixPosition(e.matrixWorld).applyMatrix4(De), te.push(e, null, e.material, r, Ue.z, null);
                        else if ((e.isMesh || e.isLine || e.isPoints) && (e.isSkinnedMesh && e.skeleton.update(), !e.frustumCulled || Te.intersectsObject(e))) {
                            a && Ue.setFromMatrixPosition(e.matrixWorld).applyMatrix4(De);
                            var o = st.update(e),
                                s = e.material;
                            if (Array.isArray(s))
                ...
                function w(e, t, r) {
                    ...
                    else if (s.stateID !== l.stateID || s.directionalLength !== l.directionalLength || s.pointLength !== l.pointLength || s.spotLength !== l.spotLength || s.rectAreaLength !== l.rectAreaLength || s.hemiLength !== l.hemiLength || s.shadowsLength !== l.shadowsLength) s.stateID = l.stateID, s.directionalLength = l.directionalLength, s.pointLength = l.pointLength, s.spotLength = l.spotLength, s.rectAreaLength = l.rectAreaLength, s.hemiLength = l.hemiLength, s.shadowsLength = l.shadowsLength, u = !1;
                    else {
                ...
                try {
                    ...
                    if (X.addEventListener("webglcontextlost", o, !1), X.addEventListener("webglcontextrestored", s, !1), Fe = j || X.getContext("webgl", Be) || X.getContext("experimental-webgl", Be), null === Fe)
                        if (null !== X.getContext("webgl")) throw new Error("Error creating WebGL context with your selected attributes.");
                ...
                this.shadowMap = vt, this.getContext = function() {
                    ...
                    if (0 !== S) {
                        if (n.isMesh) {
                            if (!0 === i.wireframe) We.setLineWidth(i.wireframeLinewidth * t()), m.setMode(1);
                    ...
                    re = ct.get(e, t), re.init(), e.traverse(function(e) {
                        ...
                        if (t.material)
                            if (Array.isArray(t.material))
                                for (var r = 0; r < t.material.length; r++) w(t.material[r], e.fog, t);
            ...
            var Ze = r("LxkE"),
                ...
                nt = {
                    ...
                    lambert: {
                        uniforms: Object($e.b)([it.common, it.specularmap, it.envmap, it.aomap, it.lightmap, it.emissivemap, it.fog, it.lights, {
                            emissive: {
                                value: new tt.a(0)
                            }
                        }]),
                    ...
                    matcap: {
                        uniforms: Object($e.b)([it.common, it.bumpmap, it.normalmap, it.displacementmap, it.fog, {
                            matcap: {
                                value: null
                            }
                        }]),
                    ...
                    normal: {
                        uniforms: Object($e.b)([it.common, it.bumpmap, it.normalmap, it.displacementmap, {
                            opacity: {
                                value: 1
                            }
                        }]),
                    ...
                    shadow: {
                        uniforms: Object($e.b)([it.lights, it.fog, {
                            color: {
                                value: new tt.a(0)
                            },
                            opacity: {
        ...
        LxkE: function(e, t, r) {
            ...
            Object.assign(a.prototype, {
                ...
                intersectsSphere: function(e) {
                    for (var t = this.planes, r = e.center, a = -e.radius, n = 0, i; 6 > n; n++)
                ...
                intersectsBox: function() {
                    ...
                    return function(t) {
                        for (var r = this.planes, a = 0, i; 6 > a; a++)
                            if (i = r[a], e.x = 0 < i.normal.x ? t.max.x : t.min.x, e.y = 0 < i.normal.y ? t.max.y : t.min.y, e.z = 0 < i.normal.z ? t.max.z : t.min.z, 0 > i.distanceToPoint(e)) return !1;
                        return !0
                    }
                }(),
                containsPoint: function(e) {
        ...
        Ncdj: function(e, t, r) {
            ...
            function a(e, t) {
                m.a.call(this), this.type = "Mesh", this.geometry = void 0 === e ? new v.a : e, this.material = void 0 === t ? new h.a({
                    color: 16777215 * Math.random()
                }) : t, this.drawMode = f.hc, this.updateMorphTargets()
            }
            var n = Math.floor,
                o = Math.max,
                s = Math.min,
                ...
                updateMorphTargets: function() {
                    ...
                    if (e.isBufferGeometry) {
                        ...
                        if (0 < n.length) {
                            var o = i[n[0]];
                            if (void 0 !== o)
                                for (this.morphTargetInfluences = [], this.morphTargetDictionary = {}, (t = 0, r = o.length); t < r; t++) a = o[t].name || t + "", this.morphTargetInfluences.push(0), this.morphTargetDictionary[a] = t
                        }
                    } else {
                        ...
                        if (void 0 !== g && (null === u.boundingSphere && u.computeBoundingSphere(), h.copy(u.boundingSphere), h.applyMatrix4(T), !1 !== l.ray.intersectsSphere(h)) && (r.getInverse(T), m.copy(l.ray).applyMatrix4(r), null === u.boundingBox || !1 !== m.intersectsBox(u.boundingBox))) {
                            ...
                            if (u.isBufferGeometry) {
                                var P = u.index,
                                    ...
                                    D = u.groups,
                                    R = u.drawRange,
                                    N, I, z, c, U, F, G, O, B, V, H;
                                if (null !== P) {
                                    if (Array.isArray(g))
                                        for (c = 0, F = D.length; c < F; c++)
                                            for (O = D[c], B = g[O.materialIndex], V = o(O.start, R.start), H = s(O.start + O.count, R.start + R.count), (U = V, G = H); U < G; U += 3) N = P.getX(U), I = P.getX(U + 1), z = P.getX(U + 2), w = t(this, B, l, m, C, A, N, I, z), w && (w.faceIndex = n(U / 3), w.face.materialIndex = O.materialIndex, p.push(w));
                                    else
                                        for (V = o(0, R.start), H = s(P.count, R.start + R.count), (c = V, F = H); c < F; c += 3) N = P.getX(c), I = P.getX(c + 1), z = P.getX(c + 2), w = t(this, g, l, m, C, A, N, I, z), w && (w.faceIndex = n(c / 3), p.push(w));
                                } else if (void 0 !== C)
                                    if (Array.isArray(g))
                                        for (c = 0, F = D.length; c < F; c++)
                                            for (O = D[c], B = g[O.materialIndex], V = o(O.start, R.start), H = s(O.start + O.count, R.start + R.count), (U = V, G = H); U < G; U += 3) N = U, I = U + 1, z = U + 2, w = t(this, B, l, m, C, A, N, I, z), w && (w.faceIndex = n(U / 3), w.face.materialIndex = O.materialIndex, p.push(w));
                                    else
                                        for (V = o(0, R.start), H = s(C.count, R.start + R.count), (c = V, F = H); c < F; c += 3) N = c, I = c + 1, z = c + 2, w = t(this, g, l, m, C, A, N, I, z), w && (w.faceIndex = n(c / 3), p.push(w))
        ...
        UKne: function(e, t, r) {
            ...
            function a() {
                Object.defineProperty(this, "id", {
                    value: h += 2
                }), this.uuid = f.a.generateUUID(), this.name = "", this.type = "Geometry", this.vertices = [], this.colors = [], this.faces = [], this.faceVertexUvs = [
                    []
            ...
            a.prototype = Object.assign(Object.create(i.a.prototype), {
                ...
                fromBufferGeometry: function(e) {
                    ...
                    if (0 < h.length)
                        for (var c = 0; c < h.length; c++)
                            for (var v = h[c], x = v.start, y = v.count, i = x; i < x + y; i += 3) void 0 === a ? t(i, i + 1, i + 2, v.materialIndex) : t(a[i], a[i + 1], a[i + 2], v.materialIndex);
                    else if (void 0 !== a)
                        for (var c = 0; c < a.length; c += 3) t(a[c], a[c + 1], a[c + 2]);
                    else
                        for (var c = 0; c < s.length / 3; c += 3) t(c, c + 1, c + 2);
                ...
                computeVertexNormals: function(e) {
                    ...
                    if (e) {
                        ...
                        for (this.computeFaceNormals(), a = 0, i = this.faces.length; a < i; a++) n = this.faces[a], o[n.a].add(n.normal), o[n.b].add(n.normal), o[n.c].add(n.normal);
                ...
                computeMorphNormals: function() {
                    ...
                    for (r = 0, i = this.faces.length; r < i; r++)
                        for (n = this.faces[r], n.__originalFaceNormal ? n.__originalFaceNormal.copy(n.normal) : n.__originalFaceNormal = n.normal.clone(), n.__originalVertexNormals || (n.__originalVertexNormals = []), (e = 0, t = n.vertexNormals.length); e < t; e++) n.__originalVertexNormals[e] ? n.__originalVertexNormals[e].copy(n.vertexNormals[e]) : n.__originalVertexNormals[e] = n.vertexNormals[e].clone();
                    var o = new a;
                ...
                copy: function(e) {
                    ...
                    for (t = 0, r = g.length; t < r; t++) {
                        ...
                        if (void 0 !== g[t].vertices)
                            for (f.vertices = [], a = 0, i = g[t].vertices.length; a < i; a++) f.vertices.push(g[t].vertices[a].clone());
                        if (void 0 !== g[t].normals)
                            for (f.normals = [], a = 0, i = g[t].normals.length; a < i; a++) f.normals.push(g[t].normals[a].clone());
                    ...
                    for (t = 0, r = h.length; t < r; t++) {
                        ...
                        if (void 0 !== h[t].vertexNormals)
                            for (v.vertexNormals = [], a = 0, i = h[t].vertexNormals.length; a < i; a++) {
                                var x = h[t].vertexNormals[a],
                                    y = {};
                                y.a = x.a.clone(), y.b = x.b.clone(), y.c = x.c.clone(), v.vertexNormals.push(y)
                            }
                        if (void 0 !== h[t].faceNormals)
                            for (v.faceNormals = [], a = 0, i = h[t].faceNormals.length; a < i; a++) v.faceNormals.push(h[t].faceNormals[a].clone());
        ...
        brnI: function(e, t, r) {
            ...
            function i(e, r) {
                function t(e) {
                    ...
                    var J = e.extractPoints(D),
                        ...
                        $, ee, h;
                    if (K)
                        for (Z = Z.reverse(), ee = 0, h = Q.length; ee < h; ee++) $ = Q[ee], y.a.isClockWise($) && (Q[ee] = $.reverse());
                    ...
                    for (k = 0; k < G; k++) {
                        ...
                        for (ee = 0, h = Q.length; ee < h; ee++)
                            for ($ = Q[ee], me = pe[ee], (oe = 0, i = $.length); oe < i; oe++) de = g($[oe], me[oe], b), E(de.x, de.y, -t)
                    }
                    ...
                    var ge;
                    for (ge = 1; ge <= R; ge++)
                        for (oe = 0; oe < ae; oe++) de = I ? g(Z[oe], ue[oe], b) : Z[oe], V ? (X.copy(W.normals[ge]).multiplyScalar(de.x), q.copy(W.binormals[ge]).multiplyScalar(de.y), Y.copy(H[ge]).add(X).add(q), E(Y.x, Y.y, Y.z)) : E(de.x, de.y, N / R * ge);
                    for (k = G - 1; 0 <= k; k--) {
                        for (le = k / G, t = U * u(le * d / 2), b = F * p(le * d / 2), (oe = 0, i = re.length); oe < i; oe++) de = g(re[oe], ne[oe], b), E(de.x, de.y, N + t);
                        for (ee = 0, h = Q.length; ee < h; ee++)
                            for ($ = Q[ee], me = pe[ee], (oe = 0, i = $.length); oe < i; oe++) de = g($[oe], me[oe], b), V ? E(de.x, de.y + H[R - 1].y, H[R - 1].x + t) : E(de.x, de.y, N + t)
                    }
                    M(), S()
                }
            ...
            function n(e, t, r) {
                if (r.shapes = [], Array.isArray(e))
                    for (var a = 0, i = e.length, n; a < i; a++) n = e[a], r.shapes.push(n.uuid);
        ...
        cuij: function(e, t, r) {
            ...
            Object.assign(a.prototype, {
                ...
                setHSL: function() {
                    ...
                    return function(t, r, a) {
                        if (t = d.a.euclideanModulo(t, 1), r = d.a.clamp(r, 0, 1), a = d.a.clamp(a, 0, 1), 0 === r) this.r = this.g = this.b = a;
                        else {
                            var i = .5 >= a ? a * (1 + r) : a + r - a * r,
                                n = 2 * a - i;
        ...
        p1p1: function(e, t, r) {
            ...
            function n() {
                Object.defineProperty(this, "id", {
                    value: f++
                }), this.uuid = u.a.generateUUID(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = n.DefaultUp.clone();
                var e = new d.a,
                    t = new a,
                    r = new l.a,
                    o = new d.a(1, 1, 1);
            ...
            n.DefaultUp = new d.a(0, 1, 0), n.DefaultMatrixAutoUpdate = !0, n.prototype = Object.assign(Object.create(p.a.prototype), {
                ...
                updateWorldMatrix: function(e, t) {
                    ...
                    if (!0 === e && null !== r && r.updateWorldMatrix(!0, !1), this.matrixAutoUpdate && this.updateMatrix(), null === this.parent ? this.matrixWorld.copy(this.matrix) : this.matrixWorld.multiplyMatrices(this.parent.matrixWorld, this.matrix), !0 === t)
                        for (var a = this.children, n = 0, i = a.length; n < i; n++) a[n].updateWorldMatrix(!1, !0)
                },
                toJSON: function(e) {
                    function t(t, r) {
                    ...
                    if (o.uuid = this.uuid, o.type = this.type, "" !== this.name && (o.name = this.name), !0 === this.castShadow && (o.castShadow = !0), !0 === this.receiveShadow && (o.receiveShadow = !0), !1 === this.visible && (o.visible = !1), !1 === this.frustumCulled && (o.frustumCulled = !1), 0 !== this.renderOrder && (o.renderOrder = this.renderOrder), "{}" !== JSON.stringify(this.userData) && (o.userData = this.userData), o.layers = this.layers.mask, o.matrix = this.matrix.toArray(), !1 === this.matrixAutoUpdate && (o.matrixAutoUpdate = !1), this.isMesh && this.drawMode !== g.hc && (o.drawMode = this.drawMode), this.isMesh || this.isLine || this.isPoints) {
                        ...
                        if (void 0 !== s && void 0 !== s.shapes) {
                            var d = s.shapes;
                            if (Array.isArray(d))
                                for (var c = 0, i = d.length, l; c < i; c++) l = d[c], t(e.shapes, l);
                            else t(e.shapes, d)
                        }
                    }
                ...
                copy: function(e, t) {
                    if (void 0 === t && (t = !0), this.name = e.name, this.up.copy(e.up), this.position.copy(e.position), this.quaternion.copy(e.quaternion), this.scale.copy(e.scale), this.matrix.copy(e.matrix), this.matrixWorld.copy(e.matrixWorld), this.matrixAutoUpdate = e.matrixAutoUpdate, this.matrixWorldNeedsUpdate = e.matrixWorldNeedsUpdate, this.layers.mask = e.layers.mask, this.visible = e.visible, this.castShadow = e.castShadow, this.receiveShadow = e.receiveShadow, this.frustumCulled = e.frustumCulled, this.renderOrder = e.renderOrder, this.userData = JSON.parse(JSON.stringify(e.userData)), !0 === t)
                        for (var r = 0, a; r < e.children.length; r++) a = e.children[r], this.add(a.clone());
                    return this
                }
            })
        },
                ...
                removeEventListener: function(e, t) {
                    if (void 0 !== this._listeners) {
                        var r = this._listeners,
                            a = r[e];
                        if (void 0 !== a) {
                            var i = a.indexOf(t); - 1 !== i && a.splice(i, 1)
                        }
                    }
                },
        ...
        zfxg: function(e, t, r) {
            ...
            function n() {
                Object.defineProperty(this, "id", {
                    value: h += 2
                }), this.uuid = g.a.generateUUID(), this.name = "", this.type = "BufferGeometry", this.index = null, this.attributes = {}, this.morphAttributes = {}, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
                    start: 0,
                    count: Infinity
                }, this.userData = {}
            }
            ...
            n.prototype = Object.assign(Object.create(s.a.prototype), {
                ...
                computeVertexNormals: function() {
                    ...
                    if (t.position) {
                        ...
                        if (void 0 === t.normal) this.addAttribute("normal", new d.a(new Float32Array(r.length), 3));
                        else
                            for (var a = t.normal.array, n = 0, i = a.length; n < i; n++) a[n] = 0;
                        var s = t.normal.array,
                            ...
                            g, f, h;
                        if (e)
                            for (var v = e.array, n = 0, i = e.count; n < i; n += 3) g = 3 * v[n + 0], f = 3 * v[n + 1], h = 3 * v[n + 2], l.fromArray(r, g), c.fromArray(r, f), p.fromArray(r, h), u.subVectors(p, c), m.subVectors(l, c), u.cross(m), s[g] += u.x, s[g + 1] += u.y, s[g + 2] += u.z, s[f] += u.x, s[f + 1] += u.y, s[f + 2] += u.z, s[h] += u.x, s[h + 1] += u.y, s[h + 2] += u.z;
                        else
                            for (var n = 0, i = r.length; n < i; n += 9) l.fromArray(r, n), c.fromArray(r, n + 3), p.fromArray(r, n + 6), u.subVectors(p, c), m.subVectors(l, c), u.cross(m), s[n] = u.x, s[n + 1] = u.y, s[n + 2] = u.z, s[n + 3] = u.x, s[n + 4] = u.y, s[n + 5] = u.z, s[n + 6] = u.x, s[n + 7] = u.y, s[n + 8] = u.z;
                ...
                merge: function(e, t) {
                    ...
                    for (var a in r)
                        if (void 0 !== e.attributes[a])
                            for (var n = r[a], o = n.array, s = e.attributes[a], l = s.array, d = s.itemSize, c = 0, i = d * t; c < l.length; c++, i++) o[i] = l[c];
                    return this
                },
