...
try {
    ...
    function rebuildMasonry() {
        ...
        }).addClass("isotope"), $(".tattoos-wrapper").isotope("on", "arrangeComplete", function() {
    ...
    function escapeRegExp(t) {
        ...
        var _t = function(t) {
            ...
            var w, T, b, S, C, k, E, O, P, M, A, L, D, I, R, N, F, z, j, q = "sizzle" + 1 * new Date,
                ...
                Tt = function(t, e) {
                    return e ? "\0" === t ? "ù" : t.slice(0, -1) + "\\" + t.charCodeAt(t.length - 1).toString(16) + " " : "\\" + t
                },
                bt = function() {
                    L()
                },
        ...
        function(t, e) {
            ...
            function o(e) {
                if (r(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
                    ...
                    var b = t(o.height);
                    return b !== !1 && (a.height = b + (w ? 0 : g + x)), a.innerWidth = a.width - (m + _), a.innerHeight = a.height - (g + x), a.outerWidth = a.width + v, a.outerHeight = a.height + y, a
                }
            }
    ...
    function(t, e, i, n, r, o, s) {
    ...
    }(window, document, "script", "//www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-40350556-5", "auto"), ga("send", "pageview"),
        function() {
            "use strict";
            /**
        ...
        function(t) {
            ...
            var t = Array.prototype.slice,
                ...
                a = function() {
                    for (var t = n.scrollTop(), e = r.height(), i = e - s, a = t > i ? i - t : 0, l = 0, u = o.length; l < u; l++) {
                        var c = o[l],
                            ...
                            f = h - c.topSpacing - a;
                        if (c.stickyWrapper.css("height", c.stickyElement.outerHeight()), t <= f) null !== c.currentTop && (c.stickyElement.css({
                            width: "",
                            position: "",
                            top: ""
                            ...
                            if (p < 0 ? p += c.topSpacing : p = c.topSpacing, c.currentTop !== p) {
                                var d;
                                c.getWidthFrom ? d = $(c.getWidthFrom).width() || null : c.widthFromWrapper && (d = c.stickyWrapper.width()), null == d && (d = c.stickyElement.width()), c.stickyElement.css("width", d).css("position", "fixed").css("top", p), c.stickyElement.parent().addClass(c.className), null === c.currentTop ? c.stickyElement.trigger("sticky-start", [c]) : c.stickyElement.trigger("sticky-update", [c]), c.currentTop === c.topSpacing && c.currentTop > p || null === c.currentTop && p < c.topSpacing ? c.stickyElement.trigger("sticky-bottom-reached", [c]) : null !== c.currentTop && p === c.topSpacing && c.currentTop < p && c.stickyElement.trigger("sticky-bottom-unreached", [c]), c.currentTop = p
                            }
                ...
                l = function() {
                    ...
                    for (var t = 0, e = o.length; t < e; t++) {
                        var i = o[t],
                            r = null;
                        i.getWidthFrom ? i.responsiveWidth && (r = $(i.getWidthFrom).width()) : i.widthFromWrapper && (r = i.stickyWrapper.width()), null != r && i.stickyElement.css("width", r)
                    }
                },
                u = {
                    init: function(t) {
                        ...
                        return this.each(function() {
                            ...
                            e.center && a.css({
                                ...
                                float: "right"
                            }), e.stickyElement = t, e.stickyWrapper = a, e.currentTop = null, o.push(e), u.setWrapperHeight(this), u.setupChangeListeners(this)
                        })
                    },
                    ...
                    unstick: function(t) {
                        return this.each(function() {
                            for (var t = this, i = $(t), n = -1, r = o.length; r-- > 0;) o[r].stickyElement.get(0) === t && (e.call(o, r, 1), n = r);
                            n !== -1 && (i.unwrap(), i.css({
                                width: "",
                                position: "",
                                top: "",
            ...
            window.addEventListener ? (window.addEventListener("scroll", a, !1), window.addEventListener("resize", l, !1)) : window.attachEvent && (window.attachEvent("onscroll", a), window.attachEvent("onresize", l)), $.fn.sticky = function(e) {
