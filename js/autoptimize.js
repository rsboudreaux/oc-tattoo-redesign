try {
  var daink = {
    root: "https://oc-tattoo.netlify.com/",
    url: {
      site: "https://oc-tattoo.netlify.com/",
      path: "/",
      ajax: "https://oc-tattoo.netlify.com/wp-admin/admin-ajax.php"
    }
  };
} catch (e) {}
try {
  function FastClick(t, e) {
    ...
    (e = e || {}),
      ...
      FastClick.notNeeded(t) ||
        (deviceIsAndroid &&
          (t.addEventListener("mouseover", i(this.onMouse, this), !0),
  ...
  function atvImg() {
    function t(t, e, i, n, r, a) {
      var l = o.scrollTop || s.scrollTop,
        ...
        S = (180 * b) / Math.PI - 90;
      0 > S && (S += 360),
        -1 != i.firstChild.className.indexOf(" over") &&
          (T += " scale3d(1.05,1.05,1.05)"),
  ...
  function rebuildMasonry() {
    function t() {
      0 == $("#masonry-container").height()
        ? $(".nothing-found").addClass("show")
        : $(".nothing-found").removeClass("show");
    }
    $("#masonry-container").hasClass("isotope") &&
    ...
    var o = $("#search-tattoo").keyup(
      debounce(function() {
        (e = new RegExp(o.val(), "gi")), $(".tattoos-wrapper").isotope(), t();
      }, 200)
    );
    $("#category-tattoos-buttons").on("click", "button", function() {
      (i = $(this).attr("data-filter")), $(".tattoos-wrapper").isotope(), t();
    }),
      $("#artist-buttons").on("click", "button", function() {
        (n = $(this).attr("data-filter")), $(".tattoos-wrapper").isotope(), t();
      }),
      $("#year-buttons").on("click", "button", function() {
        (r = $(this).attr("data-filter")), $(".tattoos-wrapper").isotope(), t();
      }),
      $(".view-grid").click(function() {
        var t = new TimelineMax();
        t
          .add(
            TweenMax.to(".masonry-module", 0.4, {
              height: "350px"
            })
          )
          .add(
            TweenMax.to(".trigger-grid", 0.2, {
              css: {
                color: "#fff"
              }
            })
          ...
          .add(
            TweenMax.to(".icon-grid-default", 0.2, {
              opacity: 1
            }),
            "=-0.2"
          )
          .add(
            TweenMax.to(".trigger-masonry", 0.2, {
              css: {
                color: "#3C3C3C"
              }
            })
          ...
          .add(
            TweenMax.to(".icon-masonry-default", 0.2, {
              opacity: 0.2
            }),
            "=-0.2"
          ),
    ...
    $(".news-wrapper")
      ...
      .addClass("isotope");
    var l = $("#search-news").keyup(
      debounce(function() {
        (s = new RegExp(l.val(), "gi")), $(".news-wrapper").isotope(), t();
      }, 200)
    );
    $("#category-buttons").on("click", "button", function() {
      (a = $(this).attr("data-filter")), $(".news-wrapper").isotope(), t();
    }),
  ...
  function debounce(t, e) {
    ...
    return function n() {
      ...
      i && clearTimeout(i), (i = setTimeout(r, e || 100));
    };
  }
  ...
  !(function(t, e) {
    ...
    function s(t) {
      var e = {};
      return (
        dt.each(t.match(Mt) || [], function(t, i) {
          e[i] = !0;
        }),
        e
      );
    ...
    function $(t, e, i) {
      ...
      if (void 0 === i && 1 === t.nodeType)
        if (
          ((n = "data-" + e.replace(zt, "-$&").toLowerCase()),
          (i = t.getAttribute(n)),
          "string" == typeof i)
        ) {
          try {
      ...
      for (var i, n, r = [], o = 0, s = t.length; o < s; o++)
        (n = t[o]),
          n.style &&
            ...
            e
              ? ("none" === i &&
                  ((r[o] = Rt.get(n, "display") || null),
                  r[o] || (n.style.display = "")),
                "" === n.style.display && Wt(n) && (r[o] = d(n)))
              : "none" !== i && ((r[o] = "none"), Rt.set(n, "display", i)));
    ...
    function k(t, e) {
      ...
      if (1 === e.nodeType) {
        if (
          Rt.hasData(t) &&
          ((o = Rt.access(t)), (s = Rt.set(e, o)), (u = o.events))
        ) {
    ...
    function O(t, e, n, r) {
      ...
      if (
        ...
        for (a = dt.map(g(o, "script"), S), l = a.length; h < f; h++)
          (u = o),
            h !== p &&
              ((u = dt.clone(u, !0, !0)), l && dt.merge(a, g(u, "script"))),
            n.call(t[h], u, h);
        if (l)
          for (
            c = a[a.length - 1].ownerDocument, dt.map(a, C), h = 0;
            h < l;
            h++
          )
            (u = a[h]),
    ...
    function P(t, e, i) {
      for (var n, r = e ? dt.filter(e, t) : t, o = 0; null != (n = r[o]); o++)
        i || 1 !== n.nodeType || dt.cleanData(g(n)),
          n.parentNode &&
            (i && dt.contains(n.ownerDocument, n) && v(g(n, "script")),
    ...
    function I(t, e, i, n, r) {
      ...
      for (
        ...
        "margin" === i && (s += dt.css(t, i + $t[o], !0, r)),
          n
            ? ("content" === i && (s -= dt.css(t, "padding" + $t[o], !0, r)),
              "margin" !== i &&
                (s -= dt.css(t, "border" + $t[o] + "Width", !0, r)))
            : ((s += dt.css(t, "padding" + $t[o], !0, r)),
              "padding" !== i &&
                (s += dt.css(t, "border" + $t[o] + "Width", !0, r)));
      return s;
    }
    ...
    function j(t, e) {
      ...
      for (e = e ? 1 : 0; n < 4; n += 2 - e)
        (i = $t[n]), (r["margin" + i] = r["padding" + i] = t);
    ...
    function q(t, e, i) {
      for (
        var n,
          r = (H.tweeners[e] || []).concat(H.tweeners["*"]),
          o = 0,
          s = r.length;
        o < s;
        o++
          ...
          if (null != (t = arguments[a]))
            for (e in t)
              (i = s[e]),
                (n = t[e]),
                s !== n &&
                  (u && n && (dt.isPlainObject(n) || (r = dt.isArray(n)))
                    ? (r
                        ? ((r = !1), (o = i && dt.isArray(i) ? i : []))
                        : (o = i && dt.isPlainObject(i) ? i : {}),
                      (s[e] = dt.extend(u, o, n)))
                    : void 0 !== n && (s[e] = n));
        return s;
      }),
    ...
    var _t = (function(t) {
      function e(t, e, i, n) {
        ...
        if (
          !n &&
          ((e ? e.ownerDocument || e : W) !== D && L(e), (e = e || D), R)
        ) {
          if (11 !== d && (l = yt.exec(t)))
            if ((r = l[1])) {
              if (9 === d) {
        ...
        return (
          ...
          n(function(n, s, a, l) {
            var u,
              ...
              _ = i ? (o || (n ? t : d || r) ? [] : s) : y;
            if ((i && i(y, _, a, l), r))
              for (u = v(_, p), r(u, [], a, l), c = u.length; c--; )
                (h = u[c]) && (_[p[c]] = !(y[p[c]] = h));
            if (n) {
              if (o || t) {
                if (o) {
        ...
        var r = i.length > 0,
          ...
          s = function(n, s, a, l, u) {
            ...
            for (
              ...
              if (o && c) {
                for (
                  h = 0, s || c.ownerDocument === D || (L(c), (a = !R));
                  (f = t[h++]);
            ...
            if (((p += d), r && d !== p)) {
              ...
              if (n) {
                if (p > 0) for (; d--; ) m[d] || g[d] || (g[d] = Z.call(l));
                g = v(g);
              }
              K.apply(l, g),
      ...
      (T = e.support = {}),
        ...
        (L = e.setDocument = function(t) {
          ...
          return n !== D && 9 === n.nodeType && n.documentElement
            ? ((D = n),
              ...
              (b.find.TAG = T.getElementsByTagName
                ? function(t, e) {
              ...
              (F = []),
              (N = []),
              (T.qsa = vt.test(D.querySelectorAll)) &&
                (r(function(t) {
                    ...
                    return i
                      ...
                      : ((i =
                        ...
                        (!T.sortDetached && e.compareDocumentPosition(t) === i)
                          ? t === D || (t.ownerDocument === W && j(W, t))
                            ? -1
                            : e === D || (e.ownerDocument === W && j(W, e))
                            ? 1
                            : M
                            ? et(M, t) - et(M, e)
                            : 0
        ...
        (e.attr = function(t, e) {
          ...
          var i = b.attrHandle[e.toLowerCase()],
            n =
              i && G.call(b.attrHandle, e.toLowerCase()) ? i(t, e, !R) : void 0;
          return void 0 !== n
            ? n
            : T.attributes || !R
            ? t.getAttribute(e)
        ...
        (O = e.select = function(t, e, i, n) {
          ...
          if (((i = i || []), 1 === c.length)) {
            if (
              ...
              if (
                ((e = (b.find.ID(s.matches[0].replace(_t, xt), e) || [])[0]),
                !e)
              )
                return i;
            ...
            for (
              ...
              if (
                (l = b.find[a]) &&
                (n = l(
                  s.matches[0].replace(_t, xt),
                  ($.test(o[0].type) && h(e.parentNode)) || e
                ))
              ) {
    ...
    (dt.filter = function(t, e, i) {
      ...
      dt.fn.extend({
          ...
          if ("string" != typeof t)
            return this.pushStack(
              dt(t).filter(function() {
                for (e = 0; e < n; e++) if (dt.contains(r[e], this)) return !0;
              })
            );
        ...
        is: function(t) {
          return !!r(
            this,
            "string" == typeof t && Tt.test(t) ? dt(t) : t || [],
            !1
          ).length;
        }
      });
        ...
        function(t, e) {
          dt.fn[t] = function(i, n) {
            ...
            return (
              ...
              this.length > 1 &&
                (Pt[t] || dt.uniqueSort(r), Ot.test(t) && r.reverse()),
              this.pushStack(r)
            );
          };
        }
    ...
    (dt.Callbacks = function(t) {
      ...
      dt.extend({
                      ...
                      h = function() {
                        ...
                        if (!(e < s)) {
                          ...
                          (h =
                            ...
                            dt.isFunction(h)
                              ? r
                                ? h.call(t, o(s, i, a, r), o(s, i, l, r))
                                : (s++,
                                  h.call(
                                    t,
                                    o(s, i, a, r),
                                    o(s, i, l, r),
                                    o(s, i, a, i.notifyWith)
                                  ))
                              : (n !== a && ((u = void 0), (c = [t])),
                                (r || i.resolveWith)(u, c));
                        }
                        ...
                        : function() {
                            try {
                              ...
                              dt.Deferred.exceptionHook &&
                                dt.Deferred.exceptionHook(t, f.stackTrace),
                                e + 1 >= s &&
                                  (n !== l && ((u = void 0), (c = [t])),
                                  i.rejectWith(u, c));
                            }
        ...
        when: function(t) {
          ...
          if (
            e <= 1 &&
            (u(t, o.done(s(i)).resolve, o.reject),
      ...
      dt.fn.extend({
        data: function(t, e) {
          ...
          if (void 0 === t) {
            if (
              this.length &&
              ((r = Nt.get(o)), 1 === o.nodeType && !Rt.get(o, "hasDataAttrs"))
            ) {
              for (i = s.length; i--; )
                s[i] &&
                  ((n = s[i].name),
                  0 === n.indexOf("data-") &&
                    ((n = dt.camelCase(n.slice(5))), $(o, n, r[n])));
    ...
    (dt.event = {
            ...
            (a = Kt.exec(e[u]) || []),
              ...
              p &&
                ...
                (f = l[p]) ||
                  ((f = l[p] = []),
                  (f.delegateCount = 0),
                  (h.setup && h.setup.call(t, n, d, s) !== !1) ||
        ...
        if (g && (l = g.events)) {
          for (e = (e || "").match(Mt) || [""], u = e.length; u--; )
            if (
              ...
              s &&
                !f.length &&
                ((h.teardown && h.teardown.call(t, d, g.handle) !== !1) ||
      ...
      dispatch: function(t) {
        ...
        if (
          ...
          for (
            a = dt.event.handlers.call(this, e, u), i = 0;
    ...
    dt.extend({
      ...
      clone: function(t, e, i) {
        ...
        if (
          ...
          for (s = g(a), o = g(t), n = 0, r = o.length; n < r; n++)
            E(o[n], s[n]);
        if (e)
          if (i)
            for (o = o || g(t), s = s || g(a), n = 0, r = o.length; n < r; n++)
              k(o[n], s[n]);
          else k(t, a);
        return (
          (s = g(a, "script")), s.length > 0 && v(s, !l && g(t, "script")), a
        );
      },
      cleanData: function(t) {
        for (
          var e, i, n, r = dt.event.special, o = 0;
          void 0 !== (i = t[o]);
          o++
        )
          if (It(i)) {
      ...
      dt.fn.extend({
        ...
        empty: function() {
          for (var t, e = 0; null != (t = this[e]); e++)
            1 === t.nodeType && (dt.cleanData(g(t, !1)), (t.textContent = ""));
          return this;
        },
        clone: function(t, e) {
          return (
        ...
        replaceWith: function() {
          ...
          return O(
            ...
            function(e) {
              ...
              dt.inArray(this, t) < 0 &&
                (dt.cleanData(g(this)), i && i.replaceChild(e, this));
            },
            t
          );
        }
      ...
      style: function(t, e, i, n) {
        if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
          var r,
            ...
            l = t.style;
          return (
            (e = dt.cssProps[a] || (dt.cssProps[a] = L(a) || a)),
        ...
        dt.cssHooks[e] = {
          ...
          set: function(t, i, n) {
            var r,
              ...
              s =
                n &&
                I(t, e, n, "border-box" === dt.css(t, "boxSizing", !1, o), o);
            return (
              s &&
                (r = qt.exec(i)) &&
                "px" !== (r[3] || "px") &&
        ...
        _default: {
          get: function(t) {
            ...
            return 1 !== t.elem.nodeType ||
              ...
              ? t.elem[t.prop]
              : ((e = dt.css(t.elem, t.prop, "")), e && "auto" !== e ? e : 0);
          },
          set: function(t) {
            dt.fx.step[t.prop]
              ? dt.fx.step[t.prop](t)
            ...
            return "undefined" == typeof t.getAttribute
              ...
              : ((1 === o && dt.isXMLDoc(t)) ||
                  (r =
                    ...
                    (dt.expr.match.bool.test(e) ? ve : void 0)),
                void 0 !== i
                  ? null === i
        ...
        propHooks: {
          tabIndex: {
            get: function(t) {
              ...
              return e
                ? parseInt(e, 10)
                : _e.test(t.nodeName) || (xe.test(t.nodeName) && t.href)
                ? 0
                : -1;
            }
          }
                ...
                if ("string" === i)
                  ...
                  (void 0 !== t && "boolean" !== i) ||
                    ...
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
                        e || t === !1 ? "" : Rt.get(this, "__className__") || ""
                      ));
              });
        },
        hasClass: function(t) {
    ...
    dt.fn.extend({
      val: function(t) {
        ...
        return arguments.length
          ...
          : r
          ? ((e = dt.valHooks[r.type] || dt.valHooks[r.nodeName.toLowerCase()]),
      ...
      dt.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function(t, e) {
              for (
                var i, n, r = t.options, o = dt.makeArray(e), s = r.length;
                s--;

              )
                (n = r[s]),
                  (n.selected =
                    dt.inArray(dt.valHooks.option.get(n), o) > -1) && (i = !0);
      ...
      trigger: function(e, i, n, r) {
        ...
        if (
          ...
          if (!r && !h.noBubble && !dt.isWindow(n)) {
            for (
              l = h.delegateType || p, Te.test(l + p) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              f.push(s), (a = s);
          ...
          return (
            ...
            r ||
              ...
              (h._default && h._default.apply(f.pop(), i) !== !1) ||
              !It(n) ||
              (u &&
                dt.isFunction(n[p]) &&
                !dt.isWindow(n) &&
        ...
        ajax: function(e, i) {
          function n(e, i, n, a) {
            ...
            c ||
              ...
              (_ = void 0),
              h &&
                g.trigger(u ? "ajaxSuccess" : "ajaxError", [b, d, u ? f : p]),
              y.fireWith(m, [b, T]),
              h &&
          ...
          (h = dt.event && d.global),
            ...
            d.ifModified &&
              (dt.lastModified[o] &&
                b.setRequestHeader("If-Modified-Since", dt.lastModified[o]),
          ...
          if (
            ...
            if (((b.readyState = 1), h && g.trigger("ajaxSend", [b, d]), c))
              return b;
            d.async &&
              d.timeout > 0 &&
    ...
    dt.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0])
          return (
            (r = e.jsonpCallback = dt.isFunction(e.jsonpCallback)
              ...
              : e.jsonpCallback),
            a
              ? (e[a] = e[a].replace(He, "$1" + r))
              : e.jsonp !== !1 &&
                (e.url += (Ce.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
      ...
      dt.each(["top", "left"], function(t, e) {
        dt.cssHooks[e] = A(ft.pixelPosition, function(t, i) {
          if (i)
            return (i = M(t, e)), se.test(i) ? dt(t).position()[e] + "px" : i;
        });
      }),
      dt.each(
        {
    ...
    return (
      (dt.noConflict = function(e) {
        return (
          t.$ === dt && (t.$ = Ye), e && t.jQuery === dt && (t.jQuery = Xe), dt
        );
      }),
      e || (t.jQuery = t.$ = dt),
      dt
    ...
    !(function(t, e, i) {
      ...
      function r() {
        ...
        for (var l in _)
          if (_.hasOwnProperty(l)) {
            ...
            for (
              r = n(e.fn, "function") ? e.fn() : e.fn, o = 0;
              o < t.length;
              o++
            )
              (s = t[o]),
      ...
      function c(t, e, i) {
        ...
        for (var o in t)
          if (t[o] in e)
            return i === !1
              ? t[o]
              : ((r = e[t[o]]), n(r, "function") ? u(r, i || e) : r);
        return !1;
      }
      ...
      function p(t, i, n, r) {
        ...
        if (parseInt(n, 10))
          for (; n--; )
            (a = l("div")), (a.id = r ? r[n] : c + (n + 1)), h.appendChild(a);
        return (
          (o = l("style")),
          (o.type = "text/css"),
          (o.id = "s" + c),
      ...
      function d(e, n) {
        ...
        if ("CSS" in t && "supports" in t.CSS) {
          for (; r--; ) if (t.CSS.supports(h(e[r]), n)) return !0;
          return !1;
        }
      ...
      function m(t, e, r, o) {
        ...
        for (
          var h, f, p, m, g, v = ["modernizr", "tspan", "samp"];
          !P.style && v.length;

        )
          (h = !0), (P.modElem = l(v.shift())), (P.style = P.modElem.style);
      ...
      (l = (function(t) {
          ...
          return (
            (t.prototype.trigger = function(t, e) {
              ...
              if (null != this.bindings[t]) {
                for (
                  o = this.bindings[t], s = [], n = 0, r = o.length;
                  r > n;
                  n++
                )
        ...
        (R = function(t) {
          ...
          if (!k.length && P.ajax) {
            ...
            if (((e = t.toUpperCase()), $.call(P.ajax.trackMethods, e) >= 0))
              return !0;
          }
          return !1;
        }),
        ...
        S().on("request", function(e) {
          ...
          return (
            ...
            I(s)
              ? void 0
              : u.running ||
                (P.restartOnRequestAfter === !1 && "force" !== R(o))
              ? void 0
              : ((n = arguments),
                ...
                setTimeout(function() {
                  ...
                  if (
                    ...
                    for (
                      u.restart(), l = u.sources, c = [], i = 0, s = l.length;
                      s > i;
                      i++
                    ) {
        ...
        (f = (function() {
          function t(t) {
            (this.source = t),
              ...
              null != this.source &&
                (this.progress = A(this.source, "progress"));
          }
          return (
        ...
        (E = function() {
          ...
          for (
            ...
            (t = s[i]), P[t] !== !1 && F.push(new h[t](P[t]));
          for (
            l = null != (a = P.extraSources) ? a : [], n = 0, o = l.length;
            o > n;
            n++
          )
            (N = l[n]), F.push(new N(P));
    ...
    (function(t, e) {
      ...
      return (
        ...
        (n._getHorizontalColPosition = function(t, e) {
          ...
          return (
            (this.horizontalColIndex = r ? i + t : this.horizontalColIndex),
            {
              col: i,
          ...
          (c.render = function(t, e, i) {
            ...
            this._onUpdate &&
              (0 > t &&
                ...
                this._startAt.render(t, e, i),
              e ||
                ((this._totalTime !== m || r) && this._callback("onUpdate"))),
              this._cycle !== g &&
                (e ||
                  this._gc ||
              ...
              if (
                ...
                for (c in p)
                  for (s = p[c].target.parentNode; s; )
                    s === t && (r = r.concat(p[c].tweens)), (s = s.parentNode);
                for (f = r.length, h = 0; f > h; h++)
            ...
            (g.add = function(r, o, s, a) {
              ...
              if (
                ...
                if (r instanceof Array || (r && r.push && l(r))) {
                  for (
                    s = s || "normal", a = a || 0, u = o, c = r.length, h = 0;
                    c > h;
                    h++
                  )
                    l((f = r[h])) &&
            ...
            (c.render = function(t, e, i) {
                ...
                if (
                  ...
                  (0 !== g ||
                    (0 === m &&
                      ...
                      (x > 0 || (0 > t && x >= 0)) &&
                      !this._locked)) &&
                    ((u = "onReverseComplete"), (o = this._reversed)),
                  0 > t)
                )
                  (this._active = !1),
                    this._timeline.autoRemoveChildren && this._reversed
                      ? ((c = o = !0), (u = "onReverseComplete"))
                      : x >= 0 && this._first && (c = !0),
                    (this._rawPrevTime = t);
                else {
                  if (
              ...
              if (this._cycle !== T && !this._locked) {
                ...
                if (
                  ...
                  return;
                if (
                  (S && ((g = b ? m + 1e-4 : -1e-4), this.render(g, !0, !1)),
                  (this._locked = !1),
                  this._paused && !w)
                )
                  return;
      ...
      (function() {
        var t = 180 / Math.PI,
            ...
            for (u = 0; T > u; u++)
              (p = t[b]),
                ...
                a
                  ? ((_ = e[u]),
                    (x = i[u]),
                    (w = ((x + _) * r * 0.25) / (s ? 0.5 : n[u] || 0.5)),
                    (d = h - (h - c) * (s ? 0.5 * r : 0 !== _ ? w / _ : 0)),
                    (m = h + (f - h) * (s ? 0.5 * r : 0 !== x ? w / x : 0)),
                    (g =
                      h -
                      (d + (((m - d) * ((3 * _) / (_ + x) + 0.5)) / 4 || 0))))
                  : ((d = h - (h - c) * r * 0.5),
                    (m = h + (f - h) * r * 0.5),
                    (g = h - (d + m) / 2)),
                (d += g),
          ...
          h = function(t, o, s, l, h, f) {
            ...
            if (t.length > 1) {
              for (x = t[t.length - 1], _ = !0, p = T.length; --p > -1; )
                if (((d = T[p]), Math.abs(b[d] - x[d]) > 0.05)) {
                  _ = !1;
                  break;
                }
              _ &&
            ...
            for (e.length = i.length = n.length = 0, p = T.length; --p > -1; )
              (d = T[p]),
                (r[d] = -1 !== h.indexOf("," + d + ",")),
                (w[d] = c(t, d, r[d], f));
            for (p = e.length; --p > -1; )
            ...
            if (!l) {
              for (p = T.length; --p > -1; )
                if (r[d])
                  for (m = w[T[p]], y = m.length - 1, g = 0; y > g; g++)
                    (v = m[g + 1].da / i[g] + m[g].da / e[g] || 0),
                      (n[g] = (n[g] || 0) + v * v);
              for (p = n.length; --p > -1; ) n[p] = Math.sqrt(n[p]);
            }
            for (p = T.length, g = s ? 4 : 1; --p > -1; )
              (d = T[p]),
                (m = w[d]),
                u(m, o, s, l, r[d]),
          ...
          f = function(t, e, i) {
            ...
            for (u = y.length; --u > -1; ) {
              for (
                f = y[u], m[f] = l = [], p = 0, h = t.length, c = 0;
                h > c;
                c++
              )
                (n =
          ...
          p = function(t, e, i) {
            for (
              var n, r, o, s, a, l, u, c, h, f, p, d = 1 / i, m = t.length;
              --m > -1;
          ...
          m = _gsScope._gsDefine.plugin({
            ...
            set: function(e) {
              ...
              if (this._timeRes) {
                ...
                a =
                  (r + (e - this._s1) / (this._s2 - this._s1)) * this._prec ||
                  0;
              } else
              ...
              for (n = 1 - a, r = this._props.length; --r > -1; )
                (o = this._props[r]),
                  (s = this._beziers[o][i]),
                  (l =
                    (a * a * s.da + 3 * n * (a * s.ca + n * s.ba)) * a + s.a),
        ...
        function(t, e) {
          ...
          var c,
            ...
            tt = (H.calculateOffset = function(t, e, i) {
              ...
              return (
                t["offset" + n] -
                (K(t, e, parseFloat(r), r.replace(T, "")) || 0)
              );
            }),
            et = function(t, e) {
              var i,
              ...
              if ((e = e || J(t, null)))
                if ((i = e.length))
                  for (; --i > -1; )
                    (r = e[i]),
                      (-1 === r.indexOf("-transform") || Ot === r) &&
                        (o[r.replace(O, M)] = e.getPropertyValue(r));
                else
                  for (i in e)
            ...
            ot = function(t, e, i) {
              ...
              for (i = i || J(t, null); --o > -1; )
                (n -= parseFloat($(t, "padding" + r[o], i, !0)) || 0),
                  (n -=
                    parseFloat($(t, "border" + r[o] + "Width", i, !0)) || 0);
              return n;
            },
            st = function(t, e) {
          ...
          var mt = function(t, e, i, n) {
            ...
            yt =
              ((H._parseToProxy = function(t, e, i, n, r, o) {
                var s,
                  a,
                  l,
                  u,
            ...
            xt = (s.parseComplex = function(t, e, i, n, r, o, a, l, u, h) {
              ...
              for (
                ...
                if (((m = P[f]), (x = M[f]), (b = parseFloat(m)), b || 0 === b))
                  a.appendXtra(
                    "",
                    b,
                    at(x, b),
                  ...
                  (E = x.indexOf(")") + 1),
                    ...
                    S && !Y && 0 === x[3]
                      ? ((a["xs" + a.l] += a.l
                          ? " transparent"
                          : "transparent"),
                        (a.e = a.e.split(M[f]).join("transparent")))
                      : (Y || (S = !1),
                        O
                          ? a
                              .appendXtra(
              ...
              if (-1 !== n.indexOf("=") && a.data) {
                for (E = a.xs0 + a.data.s, f = 1; f < a.l; f++)
            ...
            wt = 9;
          for (u = yt.prototype, u.l = u.pr = 0; --wt > 0; )
            (u["xn" + wt] = 0), (u["xs" + wt] = "");
          (u.xs0 = ""),
              ...
              if (!l[t]) {
                ...
                bt(t, {
                  parser: function(t, i, n, r, o, s, u) {
                    ...
                    return c
                      ? (c._cssRegister(), l[n].parse(t, i, n, r, o, s, u))
          ...
          var Ct,
            ...
            Rt = (function() {
              var t,
                e,
                i,
                n = m || (/Android/i.test(X) && !window.chrome);
              return (
                j.createElementNS &&
                  !n &&
                  ((t = Dt("svg", It)),
            ...
            qt = function(t, e) {
              ...
              if (
                ...
                return jt;
              for (r = (n || "").match(y) || [], wt = r.length; --wt > -1; )
                (o = Number(r[wt])),
                  (r[wt] = (s = o - (o |= 0))
                    ? ((s * u + (0 > s ? -0.5 : 0.5)) | 0) / u + o
                    : o);
              return e && r.length > 6
            ...
            $t = (H.getTransform = function(t, i, n, r) {
              ...
              var o,
                ...
                c,
                h,
                f = n ? t._gsTransform || new At() : new At(),
                p = f.scaleX < 0,
                d = 2e-5,
                m = 1e5,
                g = Mt
                  ? parseFloat($(t, Pt, i, !1, "0 0 0").split(" ")[2]) ||
                    f.zOrigin ||
                    0
                  : 0,
                v = parseFloat(s.defaultTransformPerspective) || 0;
              if (
                ((f.svg = !(!t.getBBox || !zt(t))),
                f.svg &&
                  (Nt(
                    t,
                    $(t, Pt, i, !1, "50% 50%") + "",
                ...
                if (16 === o.length) {
                  ...
                  f.zOrigin &&
                    ...
                    (f.scaleX = ((Math.sqrt(b * b + S * S) * m + 0.5) | 0) / m),
                    (f.scaleY = ((Math.sqrt(O * O + L * L) * m + 0.5) | 0) / m),
                    (f.scaleZ = ((Math.sqrt(P * P + D * D) * m + 0.5) | 0) / m),
                    f.rotationX || f.rotationY
                      ? (f.skewX = 0)
                      : ((f.skewX =
                          E || O
                            ? Math.atan2(E, O) * F + f.rotation
                            : f.skewX || 0),
                        Math.abs(f.skewX) > 90 &&
                    ...
                    (f.z = N),
                    f.svg &&
                      ((f.x -= f.xOrigin - (f.xOrigin * b - f.yOrigin * E)),
                  ...
                  for (
                    ...
                    (C = rt[wt]),
                      ...
                      (i =
                        -1 !== S.indexOf("px")
                          ? parseFloat(S)
                          : K(this.t, C, parseFloat(S), S.replace(T, "")) || 0),
                      (k =
                        i !== n[C]
                          ? 2 > wt
                            ? -n.ieOffsetX
            ...
            Bt = (H.set3DTransformRatio = H.setTransformRatio = function(t) {
              ...
              if (
                ...
                return void (E || C.skewX || F
                  ? ((E *= N),
                    ...
                    b &&
                      "simple" === C.skewType &&
                      ((y = Math.tan(b - C.skewY * N)),
                      (y = Math.sqrt(1 + y * y)),
                      (i *= y),
                      (o *= y),
                      C.skewY &&
                        ((y = Math.tan(C.skewY * N)),
                        (y = Math.sqrt(1 + y * y)),
                        (e *= y),
                        (r *= y))),
                    F &&
                      ...
                      Ct &&
                        ...
                        ((m = this.t.getBBox()),
                        (D += 0.01 * C.xPercent * m.width),
                        (I += 0.01 * C.yPercent * m.height)),
                      (m = 1e-6),
                      m > D && D > -m && (D = 0),
                      m > I && I > -m && (I = 0)),
                    (x =
              ...
              (u = 1),
                ...
                1 !== M && ((e *= M), (r *= M), (a *= M), (c *= M)),
                (d || F) &&
                  (d && ((D += n * -d), (I += s * -d), (R += u * -d + d)),
                  F &&
                    ((D +=
                      C.xOrigin - (C.xOrigin * e + C.yOrigin * i) + C.xOffset),
                    (I +=
                      C.yOrigin - (C.xOrigin * r + C.yOrigin * o) + C.yOffset)),
                  m > D && D > -m && (D = T),
                  m > I && I > -m && (I = T),
                  m > R && R > -m && (R = 0)),
                (x =
              ...
              "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
              {
                parser: function(t, e, i, n, o, a, l) {
                  ...
                  var c,
                    ...
                    P =
                      ...
                      ("function" == typeof C.transform
                        ? C.transform(v, g)
                        : C.transform);
                  if (((n._transform = O), P && "string" == typeof P && Et))
                    (h = W.style),
                      (h[Et] = P),
                      (h.display = "block"),
                      (h.position = "absolute"),
                      ...
                      null != C.xPercent &&
                        (c.xPercent = lt(C.xPercent, O.xPercent)),
                      null != C.yPercent &&
                        (c.yPercent = lt(C.yPercent, O.yPercent));
                    ...
                    "string" == typeof C.x &&
                      -1 !== C.x.indexOf("%") &&
                      ((c.x = 0), (c.xPercent = lt(C.x, O.xPercent))),
                      "string" == typeof C.y &&
                        -1 !== C.y.indexOf("%") &&
                        ((c.y = 0), (c.yPercent = lt(C.y, O.yPercent))),
                      (c.rotation = ut(
                        "rotation" in C
                          ? C.rotation
                          : "shortRotation" in C
                      ...
                      (c.skewY = ut(C.skewY, O.skewY)) &&
                        ((c.skewX += c.skewY), (c.rotation += c.skewY));
                  }
                  for (
                    Mt &&
                      null != C.force3D &&
                      ((O.force3D = C.force3D), (p = !0)),
                      O.skewType =
                        C.skewType || O.skewType || s.defaultSkewType,
                      f =
                        O.force3D ||
                        O.z ||
                        O.rotationX ||
                  ...
                  return (
                    ...
                    p &&
                      (n._transformType =
                        (O.svg && Ct) || (!f && 3 !== this._transformType)
                          ? 2
                          : 3),
                    u && (l[i] = u),
                    o
              ...
              parser: function(t, e, i, o, s, a) {
                ...
                for (
                  ...
                  this.p.indexOf("border") && (S[u] = Z(S[u])),
                    ...
                    "" === y && (y = n[i] || _),
                    y !== _ &&
                      ((w = K(t, "borderLeft", d, _)),
                      (T = K(t, "borderTop", d, _)),
                      "%" === y
                        ? ((f = (w / g) * 100 + "%"), (h = (T / v) * 100 + "%"))
                        : "em" === y
                        ? ((b = K(t, "borderLeft", 1, "em")),
                          (f = w / b + "em"),
                          (h = T / b + "em"))
                        : ((f = w + "px"), (h = T + "px")),
                      x &&
                  ...
                  9 > m
                    ? ((l = t.currentStyle),
                      ...
                      (e = this.format(e)
                        .split(",")
                        .join(u)))
                    : ((a = this.format($(t, this.p, r, !1, this.dflt))),
                      (e = this.format(e))),
            ...
            Yt = function(t) {
              if (((this.t._gsClassPT = this), 1 === t || 0 === t)) {
                ...
                for (var e = this.data, i = this.t.style; e; )
                  e.v ? (i[e.p] = e.v) : Xt(i, e.p), (e = e._next);
                1 === t &&
                      ...
                      (y && k.test(p))
                        ? (y ||
                            ...
                            (p =
                              ...
                              p.join(",") +
                              ")")),
                          (i = xt(x, s, f, p, !0, "transparent", i, 0, o)))
                        : y && R.test(p)
                        ? (i = xt(x, s, f, p, !0, null, i, 0, o))
                        : ((u = parseFloat(f)),
    ...
    (function(t, e) {
      ...
      if (!n.TweenLite) {
        ...
        var S = t.requestAnimationFrame,
          ...
          E = k();
        for (r = ["ms", "moz", "webkit", "o"], o = r.length; --o > -1 && !S; )
            ...
            if (this._timeline) {
              ...
              this._gc && this._enabled(!0, !1),
                (this._totalTime !== t || 0 === this._duration) &&
                  (I.length && Q(), this.render(t, e, !1), I.length && Q());
            }
            return this;
          }),
                        ...
                        ? o.length &&
                          ...
                          : ((this._siblings[r] = Z(o, this, !1)),
                            1 === l &&
                              ...
                              $(o, this, null, 1, this._siblings[r]))
                        : ((o = s[r--] = A.selector(o)),
            ...
            return (
              "number" !== f &&
                ...
                "string" == typeof h && (s || isNaN(h))
                  ...
                  : p ||
                    ((d.s = parseFloat(h)), (d.c = parseFloat(n) - d.s || 0))),
              d.c
          ...
          K = function(t, e, i) {
            ...
            return (
              ...
              o > e
                ...
                ? h
                : (o += t.totalDuration() / t._timeScale / r) > e + h
                ? 0
                : o - e - h
            );
          };
        (s._init = function() {
          ...
          (s._initProps = function(e, i, n, r, o) {
            ...
            for (s in this.vars)
              if (((h = this.vars[s]), X[s]))
                ...
                W[s] &&
                (u = new W[s]())._onInitTween(e, this.vars[s], this, o)
              ) {
                for (
                  this._firstPT = c = {
                    _next: this._firstPT,
          ...
          (A.getTweensOf = function(t, e) {
            ...
            if ((d(t) || L(t)) && "number" != typeof t[0]) {
              ...
              for (n = Z(t).concat(), i = n.length; --i > -1; )
      ...
      t.Controller = function(n) {
        var o,
          ...
          w = function() {
            ...
            if (((p.container = r.get.elements(p.container)[0]), !p.container))
              throw a + " init failed.";
            (y =
              p.container === window ||
              ...
              (p.refreshInterval =
                parseInt(p.refreshInterval) || h.refreshInterval),
              T();
          },
          T = function() {
            p.refreshInterval > 0 &&
              (s = window.setTimeout(P, p.refreshInterval));
          },
          b = function() {
            return p.vertical
              ? r.get.scrollTop(p.container)
              : r.get.scrollLeft(p.container);
          },
          S = function() {
            return p.vertical
              ? r.get.height(p.container)
              : r.get.width(p.container);
          },
        ...
        return (
          ...
          (this.destroy = function(t) {
            ...
            return (
              p.container.removeEventListener("resize", O),
        ...
        (t.Scene = function(i) {
              ...
              if (e) {
                ...
                s &&
                  s.forEach(function(e) {
                    (o && o !== e.namespace) ||
                      e.callback.call(h, new t.Event(r, e.namespace, h, i));
                  });
              }
              return h;
            }),
            ...
            (this.progress = function(t) {
              if (arguments.length) {
                ...
                if (
                  ...
                  c && i !== l && (m("enter"), m(i === a ? "start" : "end")),
                    m("progress"),
                    c && p !== l && (m(p === a ? "start" : "end"), m("leave"));
                }
                return h;
              }
              return d;
          ...
          var x = function() {
              (m = {
                ...
                s &&
                  f.triggerElement &&
                  (m.start -= s.info("size") * f.triggerHook),
          ...
          var M = function(t) {
              if (O && s) {
                ...
                if (t || p !== l) {
                  ...
                  P.pushFollowers
                    ? f.duration > 0 &&
                      (p === u &&
                      0 === parseFloat(r.css(P.spacer, "padding-top"))
                        ? (o = !0)
                        : p === a &&
                          0 === parseFloat(r.css(P.spacer, "padding-bottom")) &&
                          (o = !0))
                ...
                P.relSize.width || P.relSize.autoFullWidth
                  ...
                  P.relSize.height
                    ? t
                      ? r.css(O, {
                          height:
                            r.get.height(P.spacer) -
                            (P.pushFollowers ? f.duration : 0)
                        })
                      : r.css(O, {
                          height: "100%"
                        })
                  ...
                  P.pushFollowers &&
                    ((o["padding" + (e ? "Top" : "Left")] = f.duration * d),
            ...
            D = function() {
              s &&
                ...
                p === l &&
                (((P.relSize.width || P.relSize.autoFullWidth) &&
                  r.get.width(window) != r.get.width(P.spacer.parentNode)) ||
                  (P.relSize.height &&
                    r.get.height(window) !=
                      r.get.height(P.spacer.parentNode))) &&
                A();
            },
            I = function(t) {
              s &&
          ...
          (this.setPin = function(t, i) {
            ...
            if (
              (a || r.extend(f, r.css(O, ["width", "height"])),
              r.css(c, f),
              c.setAttribute(e, ""),
              ...
              if (O) {
                if ((p === l && M(!0), t || !s)) {
                  ...
                  P.spacer.parentNode.insertBefore(i, P.spacer),
                    ...
                    O.parentNode.hasAttribute(e) ||
                      (r.css(O, O.___origStyle), delete O.___origStyle);
                }
          ...
          var R,
            N = [];
          return (
            h.on("destroy.internal", function(t) {
              h.removeClassToggle(t.reset);
            }),
            (this.setClassToggle = function(t, e) {
              var i = r.get.elements(t);
              return 0 !== i.length && r.type.String(e)
                ? (N.length > 0 && h.removeClassToggle(),
                  (R = e),
                  (N = i),
                  h.on("enter.internal_class leave.internal_class", function(
                    t
                  ) {
        ...
        return (
          ...
          (f.offset = function(t, e) {
            ...
            if (t && t.getBoundingClientRect) {
              ...
              (i.top = n.top),
                (i.left = n.left),
                e || ((i.top += f.scrollTop()), (i.left += f.scrollLeft()));
            }
            return i;
          }),
        ...
        t.Scene.extend(function() {
          ...
          (n.setTween = function(o, s, a) {
            ...
            (n.removeTween = function(e) {
              return (
                t && (e && t.progress(0).pause(), t.kill(), (t = void 0)), n
              );
            });
        });
    });
  ...
  !(function(t) {
    ...
    var e = t.GreenSockGlobals || t,
      ...
      S = (n.SplitText = e.SplitText = function(t, e) {
        if (("string" == typeof t && (t = S.selector(t)), !t))
      ...
      M = function(t, e, i, n, r, a, u) {
              ...
              (m || X || (H && !B)) &&
                ...
                W &&
                  (((p._isSplit && m) ||
                    ...
                    (g.push(p), (p._x -= b), O(p, t, z) && (p._wordEnd = !0)),
                  "BR" === p.nodeName &&
                    p.nextSibling &&
                    "BR" === p.nextSibling.nodeName &&
                    W.push([])));
        for (c = 0; f > c; c++)
          (p = d[c]),
            (m = p.parentNode === t),
                ...
                !B && H
                  ? p._isSplit
                    ...
                    ? ((p._parent = p.parentNode),
                      ...
                      f--)
                    : m ||
                      ((w = !p.nextSibling && O(p.parentNode, t, z)),
                  ...
                  : H &&
                    !p._isSplit &&
                    (e.span && (p.style.display = "inline"), R.push(p)))
              : W || X
              ? (t.removeChild(p), d.splice(c--, 1), f--)
              : B || t.appendChild(p);
        if (W) {
          for (
            X &&
          ...
          for (v = " " === z && (!X || (!B && !H)), c = 0; c < W.length; c++) {
            ...
            0 === f
              ? (_.innerHTML = "&nbsp;")
              : B || H || (P(_), C(_, String.fromCharCode(160), " ")),
              X && ((_.style.width = x), (_.style.height = p._h + "px")),
              t.appendChild(_);
          }
          t.style.cssText = y;
        }
        X &&
          (u > t.clientHeight &&
            ((t.style.height = u - A + "px"),
            t.clientHeight < u && (t.style.height = u + E + "px")),
          a > t.clientWidth &&
            ((t.style.width = a - L + "px"),
      ...
      A = function(t, e, i, n) {
        ...
        for (
          ...
          if (((m = s.charAt(l)), m === P && s.charAt(l - 1) !== P && l)) {
            for (a += L ? A : "", L = !1; s.charAt(l + 1) === P; )
              (a += M), l++;
            l === c - 1
              ? (a += M)
              : ")" !== s.charAt(l + 1) && ((a += M + i()), (L = !0));
          } else
            "{" === m && "{{LT}}" === s.substr(l, 6)
              ? ((a += E ? n() + "{{LT}}</" + S + ">" : "{{LT}}"), (l += 5))
              : (m.charCodeAt(0) >= p && m.charCodeAt(0) <= d) ||
                (s.charCodeAt(l + 1) >= 65024 && s.charCodeAt(l + 1) <= 65039)
              ? ((T = x(s.substr(l, 2))),
                (b = x(s.substr(l + 2, 2))),
                (u =
                  (T >= g && v >= T && b >= g && v >= b) || (b >= y && _ >= b)
                    ? 4
                    : 2),
                (a +=
                  E && " " !== m
    ...
    (D.split = function(t) {
      ...
      for (
        var e,
          ...
          o = t.span ? "span" : "div",
          s =
            ("absolute" === t.position || t.absolute === !0,
            b(t.wordsClass, o)),
          a = b(t.charsClass, o);
        --r > -1;
            ...
            this.selEl.addEventListener("keydown", function(e) {
              ...
              switch (i) {
                ...
                case 32:
                  e.preventDefault(),
                    t._isOpen() &&
                      "undefined" != typeof t.preSelCurrent &&
                      t.preSelCurrent !== -1 &&
                      t._changeOption(),
                    t._toggleSelect();
                  break;
          ...
          this._removeFocus(),
            this._isOpen()
              ? (this.current !== -1 &&
                  ...
                  jQuery("#category-buttons")
                    .find("." + this.selPlaceholder.textContent.cleanup())
                    .trigger("click"),
                  jQuery("#category-tattoos-buttons")
                    .find("." + this.selPlaceholder.textContent.cleanup())
                    .trigger("click"),
                  jQuery("#year-buttons")
                    .find("." + this.selPlaceholder.textContent.cleanup())
                    .trigger("click"),
                  jQuery("#artist-buttons")
                    .find("." + this.selPlaceholder.textContent.cleanup())
                    .trigger("click")),
        ...
        (n.prototype._changeOption = function() {
          ...
          i && classie.remove(i, "cs-selected"),
            ...
            e.getAttribute("data-link") &&
              (this.options.newTab
                ? t.open(e.getAttribute("data-link"), "_blank")
                : (t.location = e.getAttribute("data-link"))),
      ...
      (t.prototype.needsClick = function(t) {
        ...
        (t.prototype.onTouchEnd = function(t) {
          ...
          return (
            ...
            (this.needsClick(c) || (t.preventDefault(), this.sendClick(c, t)),
            !1)
          );
        }),
    ...
    (function(t) {
        ...
        a = function() {
          for (
            ...
            var c = o[l],
              ...
              f = h - c.topSpacing - a;
            if (
              (c.stickyWrapper.css("height", c.stickyElement.outerHeight()),
              t <= f)
            )
              null !== c.currentTop &&
                (c.stickyElement.css({
              ...
              var p =
                ...
                a;
              if (
                (p < 0 ? (p += c.topSpacing) : (p = c.topSpacing),
                c.currentTop !== p)
              ) {
                var d;
                c.getWidthFrom
                  ? (d = $(c.getWidthFrom).width() || null)
                  : c.widthFromWrapper && (d = c.stickyWrapper.width()),
                  ...
                  (c.currentTop === c.topSpacing && c.currentTop > p) ||
                  (null === c.currentTop && p < c.topSpacing)
                    ? c.stickyElement.trigger("sticky-bottom-reached", [c])
                    : null !== c.currentTop &&
                      p === c.topSpacing &&
                      c.currentTop < p &&
                      c.stickyElement.trigger("sticky-bottom-unreached", [c]),
                  (c.currentTop = p);
              }
              var m = c.stickyWrapper.parent(),
                g =
                  c.stickyElement.offset().top +
                    c.stickyElement.outerHeight() >=
                    m.offset().top + m.outerHeight() &&
                  c.stickyElement.offset().top <= c.topSpacing;
              g
                ? c.stickyElement
        ...
        l = function() {
          ...
          for (var t = 0, e = o.length; t < e; t++) {
            var i = o[t],
              r = null;
            i.getWidthFrom
              ? i.responsiveWidth && (r = $(i.getWidthFrom).width())
          ...
          unstick: function(t) {
            return this.each(function() {
              for (var t = this, i = $(t), n = -1, r = o.length; r-- > 0; )
                o[r].stickyElement.get(0) === t && (e.call(o, r, 1), (n = r));
              n !== -1 &&
                (i.unwrap(),
                i.css({
                  width: "",
      ...
      window.addEventListener
        ...
        ($.fn.sticky = function(e) {
          return u[e]
            ? u[e].apply(this, t.call(arguments, 1))
            : "object" != typeof e && e
            ? void $.error("Method " + e + " does not exist on jQuery.sticky")
    ...
    $(document).ready(function() {
      ...
      function i() {
        ...
        t
          .add(
            TweenMax.to(".line-loader-container", 0.25, {
              opacity: 1
            })
          )
          .add(
          ...
          .add(
            TweenMax.to(".massive-typo", 3, {
              opacity: 1,
              scale: 1
            })
          )
          .add(
            TweenMax.to(".massive-typo-intro", 3, {
              opacity: 1,
              scale: 1
            }),
            "=-1"
          ...
          .add(
            TweenMax.to(".vertical-text", 0.55, {
              opacity: 1,
              rotation: 90,
              ease: Expo.easeOut
            }),
          ...
          (function() {
            ...
            function e(t) {
              "" === t.target.value.trim() &&
                classie.remove(t.target.parentNode, "input--filled");
            }
            [].slice
              .call(document.querySelectorAll("input.input-field"))
              .forEach(function(i) {
                "" !== i.value.trim() &&
                  classie.add(i.parentNode, "input--filled"),
      ...
      function o() {
        ...
        t.add(
          TweenMax.to(".line-scroll-down", 0, {
            y: "-100%"
          })
        ).add(
          TweenMax.to(".line-scroll-down", 1, {
            delay: 0.5,
            y: "100%",
            ease: Expo.easeOut
          })
        ...
        e.add(
          TweenMax.to(".line-loader", 0, {
            x: "-200%",
            opacity: 1
          })
        )
          .add(
            TweenMax.to(".line-loader", 1, {
              x: "100%",
              opacity: 1,
              ease: Expo.easeOut
            })
        ...
        if (
          ($("section").each(function() {
            var t = new SplitText($(this, ".split-text-body"), {
              ...
              n = new TimelineMax();
            n.add(
              TweenMax.to($(this).find(".underline-body"), 0.75, {
                x: 0,
                ease: Expo.easeOut
              })
            )
              .add(
                TweenMax.to($(this).find("h3"), 0.1, {
                  opacity: 1
                })
              )
              .add(
              ...
              .add(
                TweenMax.to($(this).find(".input-form"), 0.1, {
                  opacity: 1
                }),
                "=-0.45"
              )
          ...
          $(".merch-module")
            .on("mouseenter", function() {
              ...
              t.add(
                ...
                TweenMax.to($(this).find(".news-arrow"), 0.75, {
                  x: 35,
                  ease: Expo.easeOut
                }),
                "=-0.65"
          ...
          $(".masonry-module")
            .on("mouseenter", function() {
              ...
              t.add(
                ...
                TweenMax.to($(this).find(".merch-arrow"), 0.75, {
                  x: 35,
                  ease: Expo.easeOut
                }),
                "=-0.65"
          ...
          $(".tile")
            ...
            .on("mousemove", function(t) {
              $(this)
                ...
                .css({
                  "transform-origin":
                    ((t.pageX - $(this).offset().left) / $(this).width()) *
                      100 +
                    "% " +
                    ((t.pageY - $(this).offset().top) / $(this).height()) *
                      100 +
                    "%"
                });
            })
          ...
          "onmousewheel" in document.body
            ...
            : document.body.addEventListener("DOMMouseScroll", r);
        }
        $(".intro-section").each(function() {
          var t = new TimelineMax();
          t.add(
            TweenMax.staggerTo(
              $(this).find(".underline-intro"),
              0.75,
              {
                x: 0,
                ease: Expo.easeOut
            ...
            .add(
              TweenMax.staggerTo(
                $(this).find(".image-cover-intro-scroll"),
                0.75,
                {
                  clip: "rect(0px, 380px, 650px, 0)",
                  ease: Expo.easeOut
            ...
            .add(
              TweenMax.to($(this).find(".image-intro"), 0.1, {
                visibility: "visible"
              }),
              "=-0.5"
            )
        ...
        $(".stripes-trigger")
          .on("mouseenter", function() {
            (o = new TimelineMax({
              ...
              o
                .add(
                  TweenMax.to($(this).find(".intro-stripe-1"), 0.55, {
                    clip: "rect(0px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  })
                )
                .add(
                  TweenMax.to($(this).find(".intro-stripe-2"), 0.55, {
                    clip: "rect(0px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  }),
                  "=-0.55"
                ...
                .add(
                  TweenMax.to($(this).find(".intro-stripe-3"), 0.55, {
                    clip: "rect(0px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  }),
                  "=-0.55"
                ...
                .add(
                  TweenMax.to($(this).find(".intro-stripe-4"), 0.55, {
                    clip: "rect(0px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  }),
                  "=-0.55"
                ...
                .add(
                  TweenMax.to($(this).find(".intro-stripe-5"), 0.55, {
                    clip: "rect(0px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  }),
                  "=-0.55"
                ...
                .add(
                  TweenMax.to($(this).find(".intro-stripe-6"), 0.55, {
                    clip: "rect(0px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  }),
                  "=-0.55"
          ...
          .on("mouseleave", function() {
            o.kill(),
              ...
              s
                .add(
                  TweenMax.to($(this).find(".intro-stripe-1"), 0.3, {
                    clip: "rect(0px, 400px, 0px, 0)",
                    ease: Expo.easeOut
                  })
                )
                .add(
                  TweenMax.to($(this).find(".intro-stripe-2"), 0.3, {
                ...
                .add(
                  TweenMax.to($(this).find(".intro-stripe-3"), 0.3, {
                    clip: "rect(800px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  }),
                  "=-0.30"
                ...
                .add(
                  TweenMax.to($(this).find(".intro-stripe-4"), 0.3, {
                    clip: "rect(800px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  }),
                  "=-0.30"
                ...
                .add(
                  TweenMax.to($(this).find(".intro-stripe-5"), 0.3, {
                    clip: "rect(800px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  }),
                  "=-0.30"
                ...
                .add(
                  TweenMax.to($(this).find(".intro-stripe-6"), 0.3, {
                    clip: "rect(800px, 400px, 800px, 0)",
                    ease: Expo.easeOut
                  }),
                  "=-0.30"
          ...
          $(".reveal-tattoo").hover(
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-tattoo", 0.75, {
            ...
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-tattoo", 0.55, {
                  clip: "rect(650px, 260px, 650px, 0px)",
                  ease: Expo.easeOut
                })
              ).add(
                TweenMax.to(".image-nav-tattoo", 0, {
          ...
          $(".reveal-studio").hover(
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-studio", 0.75, {
                  clip: "rect(0px, 260px, 650px, 0px)",
                  ease: Expo.easeOut
                })
              );
            ...
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-studio", 0.55, {
                  clip: "rect(650px, 260px, 650px, 0px)",
                  ease: Expo.easeOut
                })
              ).add(
                TweenMax.to(".image-nav-studio", 0, {
                  clip: "rect(0px, 260px, 0px, 0px)"
                })
              );
            }
          ...
          $(".reveal-news").hover(
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-news", 0.75, {
                  clip: "rect(0px, 260px, 650px, 0px)",
                  ease: Expo.easeOut
                })
              );
            ...
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-news", 0.55, {
                  clip: "rect(650px, 260px, 650px, 0px)",
                  ease: Expo.easeOut
                })
              ).add(
                TweenMax.to(".image-nav-news", 0, {
                  clip: "rect(0px, 260px, 0px, 0px)"
                })
              );
            }
          ...
          $(".reveal-merch").hover(
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-merch", 0.75, {
                  clip: "rect(0px, 260px, 650px, 0px)",
                  ease: Expo.easeOut
                })
              );
            ...
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-merch", 0.55, {
                  clip: "rect(650px, 260px, 650px, 0px)",
                  ease: Expo.easeOut
                })
              ).add(
                TweenMax.to(".image-nav-merch", 0, {
                  clip: "rect(0px, 260px, 0px, 0px)"
                })
              );
            }
          ),
          $(".reveal-contacts").hover(
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-contacts", 0.75, {
                  clip: "rect(0px, 260px, 650px, 0px)",
                  ease: Expo.easeOut
                })
              );
            ...
            function() {
              var t = new TimelineMax({});
              t.add(
                TweenMax.to(".image-nav-contacts", 0.55, {
                  clip: "rect(650px, 260px, 650px, 0px)",
                  ease: Expo.easeOut
                })
              ).add(
                TweenMax.to(".image-nav-contacts", 0, {
                  clip: "rect(0px, 260px, 0px, 0px)"
                })
              );
            }
      ...
      s
        ...
        : f && $("html").addClass("is-blink"),
        $(".filter-bar-container").length > 0 &&
          ($(".filter-bar-container").sticky({
            topSpacing: 0,
            bottomSpacing:
              $("#footer").outerHeight() +
              $(".footer-nav").outerHeight() +
              $(".nav-animation.footer-nav-main").outerHeight()
          }),
          $(window).scroll(function() {
            $(window).scrollTop() + 80 >=
            $(".filter-bar-container").offset().top
              ? $(".hamburger-container").addClass("filter-active")
              : $(".hamburger-container").removeClass("filter-active");
          })),
        $(".news-content, .fix-markup")
          .find("p")
        ...
        $("body").hasClass("single-post") &&
          $(".nav-animation")
            ...
            .parent()
            .addClass("selected"),
        $("body").hasClass("single-tattoos_post-type") &&
          $(".nav-animation")
            .find(".reveal-tattoo")
            .parent()
            .addClass("selected");
