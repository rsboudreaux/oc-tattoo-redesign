!(function(e) {
  ...
  if (
    ...
    void 0 !== (a = document.getElementById("mobile-menu-button"))
  )
    if (void 0 !== (t = document.getElementById("wporg-header-menu"))) {
      for (
        -1 === t.className.indexOf("nav-menu") && (t.className += " nav-menu"),
          ...
          l = 0,
          o = (n = t.getElementsByTagName("a")).length;
        l < o;
        l++
      )
        n[l].addEventListener("focus", c, !0),
          n[l].addEventListener("blur", c, !0);
      !(function(e) {
        var a,
          t,
            ...
            a = function(e) {
              ...
              if (t.classList.contains("focus")) t.classList.remove("focus");
                ...
                for (
                  ...
                  a < t.parentNode.children.length;
                  ++a
                )
                  t !== t.parentNode.children[a] &&
